  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-72 border-r border-slate-800 bg-slate-900/50 backdrop-blur-xl sticky top-0 h-screen overflow-y-auto">
      <div class="p-6">
        ...
        <div class="space-y-8">
          ${Object.entries(spec.namespaces).map(([name, ns]) => `
            <div>
    ...
    <main class="flex-1 p-12 max-w-5xl mx-auto overflow-x-hidden">
      ...
      <div class="space-y-24">
        ${Object.entries(spec.namespaces).map(([nsName, ns]) => `
          <section id="ns-${nsName}">
            ...
            <div class="grid gap-10">
              ${Object.entries(ns.events).map(([evtName, event]) => `
                    ...
                    <div class="flex items-start justify-between mb-6">
                      <div>
                        <div class="flex items-center gap-3 mb-3">
                          <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest ${event.direction === 'client_to_server' ? 'bg-green-500/10 text-green-400 border border-green-500/20' :
